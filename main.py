            ...
            if cleaned.startswith("wait"):
                ...
                try:
                    ...
                    if selected_piece:
                        ...
                        # בדיקת חוקיות התנועה (משתמשת ב-rules.py המעודכן)
                        if validator and validator(board, selected_pos[0], selected_pos[1], row, col):
                            # מניעת תנועות נוספות בזמן שיש תנועה פעילה
                            ...
                            selected_piece = piece if piece else None
                            selected_pos = (row, col) if piece else None
                    elif piece: 
                        selected_piece, selected_pos = piece, (row, col)
                except: continue
